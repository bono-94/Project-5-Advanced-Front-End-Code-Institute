...
function ContainersPrivate({ message, filter = "" }) {
              ...
              <Col className={`ps-1 ${styles.ContainerList}`} lg={8}>
                ...
                <div className={`mt-5 mt-lg-0 mb-0 ${styles.SearchBarContainer}`}>
                  <Row fluid className={`mt-0 mb-0 ${styles.SortRow}`}>
                    <h4 className="mt-0 mt-lg-0 pt-1">Private Containers</h4>
                    <i
                ...
                {hasLoaded ? (
                  <>
                    {containers.results.length ? (
                      <InfiniteScroll
                      children={containers.results.filter((container) => container.is_owner).map((container) => (
                      ...
                      >
                        {containers.results.filter((container) => container.is_owner).map((container) => (
                          <Link
                            key={container.id}
...
export default ContainersPrivate;